...
string Mining (Blokas block[], int blcount, Blockchainas blchain[], int chcount)
{
    int n = 100000, x;
    string newhash;
    if (blcount == 0)
    ...
    cout << "Nepavyko" << endl;
    Mining(block, blcount, blchain, chcount);
...
int main()
{
    ...
    while (dydis >= 100)
    {
        ...
        blchain[chcount].hhash = Mining(block, blcount, blchain, chcount);
        for (int i = 0 ; i < 100; i++)
        {
            int send = 0, get = 0;
